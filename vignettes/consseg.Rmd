...
author: "Halima Saker, Rainer Machne, Jörg Fallmann, Ahmad M.\ Shahin, Peter F. Stadler"
...
$J(k)\coloneqq j$ for the minimum in (\#eq:recursion) is attained. Starting from
$k=n$ one obtains the optimal segmentation as segments $[J(k)+1,k]$ and
setting $k\leftarrow J(k)$ in each step.
